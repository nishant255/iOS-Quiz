...
//    @IBOutlet weak var answerLabel: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        questionLabel.text = "Are you Ready for iOS Quiz? Hit Next!"
        answerLabel.isHidden = true
    }
    ...
    func updateUI() {
        print(currentQuestion)
        print(quizBank[currentQuestion].0)
        questionLabel.text = quizBank[currentQuestion].0
        print(quizBank[currentQuestion].1)
        print(answerLabel.isHidden)
